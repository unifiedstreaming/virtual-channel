...
* Fix media segment alignment to be consistent between DASH and HLS when there are overlapping segments at transitions (#299)
* Fix DASH periods being removed when there is a short period after a transition, e.g. due to SCTE 35 at the start of a playlist (#284)
* Fix HLS media timeline drifting when media segments overlap during transitions between playlists (#270)
